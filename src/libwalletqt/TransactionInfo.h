...
public:
    enum Direction {
        Direction_In  =  Flurbo::TransactionInfo::Direction_In,
        Direction_Out =  Flurbo::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Flurbo::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Flurbo::TransactionInfo * m_pimpl;
