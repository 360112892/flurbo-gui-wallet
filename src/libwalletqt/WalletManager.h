...
public:
    enum LogLevel {
        LogLevel_Silent = Flurbo::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Flurbo::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Flurbo::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Flurbo::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Flurbo::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Flurbo::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Flurbo::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Flurbo::WalletManagerFactory::LogLevel_Max,
    };
