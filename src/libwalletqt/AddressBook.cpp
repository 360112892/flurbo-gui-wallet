...
AddressBook::AddressBook(Flurbo::AddressBook *abImpl,QObject *parent)
...
QList<Flurbo::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Flurbo::AddressBookRow * AddressBook::getRow(int index) const
{
