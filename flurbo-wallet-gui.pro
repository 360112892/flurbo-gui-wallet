...
linux {
   ...
   #     }
    ...
    # currently flurbo has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/flurbo-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/flurbo-core_ar.ts \ # Arabic
                $$PWD/translations/flurbo-core_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/flurbo-core_de.ts \ # German
                $$PWD/translations/flurbo-core_eo.ts \ # Esperanto
                $$PWD/translations/flurbo-core_es.ts \ # Spanish
                $$PWD/translations/flurbo-core_fi.ts \ # Finnish
                $$PWD/translations/flurbo-core_fr.ts \ # French
                $$PWD/translations/flurbo-core_hr.ts \ # Croatian
                $$PWD/translations/flurbo-core_id.ts \ # Indonesian
                $$PWD/translations/flurbo-core_hi.ts \ # Hindi
                $$PWD/translations/flurbo-core_it.ts \ # Italian
                $$PWD/translations/flurbo-core_ja.ts \ # Japanese
                $$PWD/translations/flurbo-core_nl.ts \ # Dutch
                $$PWD/translations/flurbo-core_pl.ts \ # Polish
                $$PWD/translations/flurbo-core_ru.ts \ # Russian
                $$PWD/translations/flurbo-core_sv.ts \ # Swedish
                $$PWD/translations/flurbo-core_zh-cn.ts \ # Chinese (Simplified-China)
                $$PWD/translations/flurbo-core_zh-tw.ts \ # Chinese (Traditional-Taiwan)
                $$PWD/translations/flurbo-core_he.ts \ # Hebrew
                $$PWD/translations/flurbo-core_ko.ts \ # Korean
                $$PWD/translations/flurbo-core_ro.ts \ # Romanian
                $$PWD/translations/flurbo-core_da.ts \ # Danish
                $$PWD/translations/flurbo-core_cs.ts \ # Czech
                $$PWD/translations/flurbo-core_sk.ts \ # Slovak
                $$PWD/translations/flurbo-core_ar.ts \ # Arabic
                $$PWD/translations/flurbo-core_sl.ts \ # Slovenian
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libflurbo-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    flurbo/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = flurbo-core.rc
